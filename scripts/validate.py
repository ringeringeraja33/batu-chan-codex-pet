#!/usr/bin/env python3
"""Validate the install-ready Batu Codex pet package."""
...
def main() -> None:
    ...
    assert manifest["id"] == "batu"
    assert manifest["displayName"] == "拔都"
    ...
    idle_open_frame_columns = (0, 1, 2, 3, 4, 5)
    ...
    ), "static western-expedition idle frames must be pixel-identical"
    ...
    report = {
        ...
        "idleBlinkFrameColumns": [],
        "animationMode": "static-western-expedition",
    ...
    print("Batu package validation passed")
